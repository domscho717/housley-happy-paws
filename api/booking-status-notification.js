        ...
        if (rp.type === 'per_card' && rp.schedules) {
          ...
          recurringHTML = `
            <div style="background:#eef4ef;border-radius:10px;padding:16px;margin:16px 0;border:1px solid #c5d8c9">
              ...
              ${lines}
              <div style="margin-top:10px;font-size:0.85rem;color:#3d5a47">💳 You will be automatically charged the Sunday before each appointment week. You can also pay early from your appointments page. Cancel anytime by contacting Rachel.</div>
            </div>`;
        }
